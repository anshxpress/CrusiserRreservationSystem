...
Public Class Cancle_Reservation
    ...
    Private Sub Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel.Click
        ...
        Else
            ...
            If Trim(AirwayClass.Text) = "First Class" And Trim(RStatus.Text) = "Confirmed" Then
                ...
                Dim cpp As String = "update ScheduleCruise set FirstClassSeatAvailable=FirstClassSeatAvailable + 1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
           ...
           "@INSERT5").Value = DateTime.Now
            ...
            Dim cd As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
    ...
    Private Sub RefundTicket_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RefundTicket.Click
        ...
        If RStatus.Text = "cancelled" Then
            ...
            frmRefundTicket.strCruiseNo = CruiseNo.Text
    ...
    Private Sub GetDetails_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GetDetails.Click
        ...
        Dim ct As String = "select pnrno, CruiseNo, Source, Destination, FName, LName, Age, Gender,TravelDate, class, RStatus, Fare  from reservations where PnrNo=@find And SePassword=@find1"
