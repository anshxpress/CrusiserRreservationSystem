    ...
    Private Sub Button4_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If ComboBox1.Text = "USER" Then
                ...
                cnPodaci.ConnectionString = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
            ...
            ElseIf ComboBox1.Text = "ADMIN" Then
                ...
                If TextBox10.Text = "admin" Or TextBox11.Text = "admin" Then
                    Beep()
                    Beep()
