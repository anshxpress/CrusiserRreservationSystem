...
Public Class ScheduleCruise
    ...
    Private Sub Submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit.Click
        ...
        Dim ct As String = "select * from ScheduleCruise where scheduleID=@find"
    ...
    Private Sub Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Add.Click
        ...
        If Len(Trim(CruiseNo.Text)) = 0 Then
            MessageBox.Show("Please select Cruise No.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        If Len(Trim(TourDate.Text)) = 0 Then
            MessageBox.Show("Please select Tour date", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        con.Open()
        Dim ct As String = "select ScheduleID from ScheduleCruise where ScheduleID=@find"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "ScheduleID"))
        ...
        Else
            ...
            Dim cp As String = "insert into ScheduleCruise(ScheduleID,CruiseNo,TourDate,FirstClassSeatAvailable,BusinessClassSeatAvailable,EconomyClassSeatAvailable) VALUES (@INSERT1,@INSERT2,@INSERT3,@INSERT4,@INSERT5,@INSERT6)"
            ...
            cmd.Parameters.Add(New SqlParameter("@INSERT2", System.Data.SqlDbType.NChar, 10, "CruiseNo"))

            cmd.Parameters.Add(New SqlParameter("@INSERT3", System.Data.SqlDbType.NChar, 30, "TourDate"))
            ...
            cmd.Parameters("@INSERT2").Value = CruiseNo.Text

            cmd.Parameters("@INSERT3").Value = TourDate.Text
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
        ...
        Dim ct As String = "delete from ScheduleCruise where ScheduleID=@delete1;"
    ...
    Private Sub Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Edit.Click
        ...
        Dim ct As String = "update ScheduleCruise set CruiseNo=@UPDATE2,TourDate=@UPDATE3,FirstClassSeatAvailable=@UPDATE4,BusinessClassSeatAvailable=@UPDATE5,EconomyClassSeatAvailable=@UPDATE6 where ScheduleID=@UPDATE1"
        ...
        cmd.Parameters.Add(
        New SqlParameter("@UPDATE2", System.Data.SqlDbType.NChar, 10, "CruiseNo"))

        cmd.Parameters.Add(
        New SqlParameter("@UPDATE3", System.Data.SqlDbType.NChar, 30, "TourDate"))
        ...
        cmd.Parameters(
        "@UPDATE2").Value = CruiseNo.Text

        cmd.Parameters(
        "@UPDATE3").Value = TourDate.Text
        cmd.Parameters(
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT * FROM ScheduleCruise "
    ...
    Private Sub Crusier_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        con = New SqlConnection(cs)
        con.Open()
        Dim ct As String = "select CruiseNo from Crusier "
    ...
    Private Sub CruiseNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CruiseNo.SelectedIndexChanged
        ...
        Dim ct As String = "select FirstClassSeats,BusinessClassSeats,EconomyClassSeats from Cruisers,Crusier where Cruisers.CruisersTypeId=Crusier.CruisersTypeId and CruiseNo='" & CruiseNo.Text & "'"
