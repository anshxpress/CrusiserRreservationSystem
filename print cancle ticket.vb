...
Public Class print_cancle_ticket
    Friend strPnrNo, strName, dRefundAmt, strStatus, strCruiseNo, strClass, strDate, Source, Destination, Fare As String
    ...
    Private Sub print_cancle_ticket_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtPrint.Text &= Chr(13) & Chr(13) & "   Ship No: " & strCruiseNo
