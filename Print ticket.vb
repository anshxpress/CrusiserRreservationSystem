...
Public Class Print_ticket
    Friend strPNRNo, strName, strSector, strCruiseNo, strClass, strDate, strDepTime, strArrTime, Status, Fare, Source, Destination, strcruiseName As String
    ...
    Private Sub Print_ticket_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtPrint.Text = "                                                 SEAWAYS TOURS & TRAVELS                                "
        ...
        txtPrint.Text &= Chr(13) & Chr(13) & "   Cruise Name: " & strcruiseName
        txtPrint.Text &= Chr(13) & Chr(13) & "   cruise No: " & strCruiseNo
