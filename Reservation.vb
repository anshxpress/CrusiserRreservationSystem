...
Public Class Reservation
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If Len(Trim(CruiseNo.Text)) = 0 Then
            MessageBox.Show("Please Specify the CruiseNo", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If (AirwayClass.Text) = "First Class" Then
            ...
            Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.FirstClassFare  from sector,Crusier where Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
        ...
        If (AirwayClass.Text) = "Business Class" Then
            ...
            Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.BusinessClassFare FROM  sector INNER JOIN Crusier ON Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
        ...
        If (AirwayClass.Text) = "Economy Class" Then
            ...
            Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.EconomyClassFare FROM  sector INNER JOIN Crusier ON Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        If TextBox3.Text = "Match" Then
            ...
            Dim cmd As SqlCommand = Nothing
            Dim cm As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"

            con = New SqlConnection(cm)

            con.Open()
            If AirwayClass.Text = "First Class" Then
                Dim ck As String = "select FirstClassSeatAvailable from ScheduleCruise where FirstClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"


                cmd = con.CreateCommand
                cmd.CommandText = "select FirstClassSeatAvailable from ScheduleCruise where FirstClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "'"
                cmd.Connection = con
                ...
                Try
                    ...
                    If dtb.Rows(0)("FirstClassSeatAvailable").ToString() > 0 Then
                        Rstatus.Text = "Confirmed"
                    Else
                        Rstatus.Text = "Waiting"
                    End If
                Catch ex As Exception
                    Rstatus.Text = "Waiting"
                End Try
                ...
                con.Close()
            End If
            Dim ca As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"

            con = New SqlConnection(ca)

            con.Open()
            If AirwayClass.Text = "Economy Class" Then
                Dim ck As String = "select EconomyClassSeatAvailable from ScheduleCruise where EconomyClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"


                cmd = con.CreateCommand
                cmd.CommandText = "select EconomyClassSeatAvailable from ScheduleCruise where EconomyClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
                cmd.Connection = con
            ...
            con.Open()
            If AirwayClass.Text = "Business Class" Then
                Dim ck As String = "select BusinessClassSeatAvailable from ScheduleCruise where BusinessClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            Dim cop As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"

            con = New SqlConnection(cop)

            con.Open()
            If AirwayClass.Text = "First Class" Then
                Dim ck As String = "update ScheduleCruise set FirstClassSeatAvailable=FirstClassSeatAvailable -1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            End If
            If AirwayClass.Text = "Business Class" Then
                Dim ck As String = "update ScheduleCruise set BusinessClassSeatAvailable=BusinessClassSeatAvailable -1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            End If
            If AirwayClass.Text = "Economy Class" Then
                Dim ck As String = "update ScheduleCruise set EconomyClassSeatAvailable=EconomyClassSeatAvailable -1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            cmd.Parameters.Add(
            New SqlParameter("@INSERT2", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
          ...
          New SqlParameter("@INSERT15", System.Data.SqlDbType.NChar, 20, "Rstatus"))
           ...
           "@INSERT16").Value = TextBox5.Text
            ...
            con.Close()
            MessageBox.Show("SUCCESSFULLY Reserved", "Cruiser Reservation", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        con.Open()
        Dim cd As String = "select CruiseNo from Reservations,cancelreservation where Reservations.PnrNo=CancelReservation.PnrNo and CruiseNo= '" & CruiseNo.Text & "'"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs1 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs2 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs3 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs4 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs6 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs7 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs8 As String = "Data Source=.\SQLEXPRESS;AttachDbFilename=D:F:\Sem.4\extra vs code\Airline Reservation System VB.Net\airline\AirlineReservationSystem.mdf;Integrated Security=True;Connect Timeout=30;User Instance=True"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs9 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs10 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cz1 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"

        con = New SqlConnection(cz1)

        con.Open()
        Dim cd1 As String = "select CruiseNo from Reservations,Collections where Reservations.PnrNo=Collections.PnrNo and CruiseNo= '" & CruiseNo.Text & "'"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cp1 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cr1 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cj1 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs12 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs21 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs31 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs41 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs51 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs61 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        con.Open()
        Dim cu71 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs81 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs91 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs101 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cz12 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"

        con = New SqlConnection(cz12)

        con.Open()
        Dim cd12 As String = "select CruiseNo from Reservations,Refunds where Reservations.PnrNo=Refunds.PnrNo and CruiseNo= '" & CruiseNo.Text & "'"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cp12 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cr12 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cj12 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs13 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs22 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs32 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs42 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs52 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs62 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs72 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs82 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs92 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
        ...
        If rdr.Read Then
            ...
            Exit Sub
        End If
        Dim cs102 As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "PnrNo"))
        ...
        Else
            ...
            cmd.Parameters.Add(
            New SqlParameter("@DELETE2", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
    ...
    Private Sub confirm_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Trim(Rstatus.Text) = "Confirmed" Then
            MessageBox.Show("This ticket is already confirmed", "Cruise ticket", MessageBoxButtons.OK, MessageBoxIcon.Error)
            initializecontrols()
        ElseIf Trim(Rstatus.Text) = "Cancelled" Then
            MessageBox.Show("not possible..please reserve new ticket", "Cruise ticket", MessageBoxButtons.OK, MessageBoxIcon.Error)
            initializecontrols()
        Else
            Dim rdr As SqlDataReader = Nothing
           ...
           New SqlCommand(cp)
            ...
            If Trim(AirwayClass.Text) = "Business Class" Then
                ...
                Dim cm As String = "update ScheduleCruise set BusinessClassSeatAvailable=BusinessClassSeatAvailable - 1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            If Trim(AirwayClass.Text) = "Economy Class" Then
                Dim cl As String = "update ScheduleCruise set EconomyClassSeatAvailable=EconomyClassSeatAvailable - 1 where ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            MessageBox.Show("Confirmed", "Cruise reservation", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub PrintTicket_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintTicket.Click
        ...
        con.Open()
        Dim ct As String = "select cruiseName,arrivalTime,departureTime from Crusier,Cruisers where Cruisers.CruisersTypeId=Crusier.CruisersTypeId and CruiseNo=@find"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
        ...
        If rdr.Read Then
            cruiser.cruiseName.Text = rdr.GetString(0)
            Crusier.ArrivalTime.Text = rdr.GetString(1)
            Crusier.DepartureTime.Text = rdr.GetString(2)

            frmPrintTicket.strCruiseNo = CruiseNo.Text
            frmPrintTicket.strPNRNo = PnrNo.Text
            frmPrintTicket.strArrTime = Crusier.ArrivalTime.Text
            frmPrintTicket.strDepTime = Crusier.DepartureTime.Text
            frmPrintTicket.strcruiseName = cruiser.cruiseName.Text
    ...
    End Sub
    Sub PopulateCruiseNo()

        Dim conn As New SqlConnection("Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;")


        conn.Open()

        Dim sql As New SqlCommand("Select CruiseNo from Crusier", conn)
        ...
        adapt.Fill(dset, "Crusier")

        conn.Close()
        CruiseNo.DataSource = dset.Tables("Crusier")
        CruiseNo.DisplayMember = "CruiseNo"
        CruiseNo.ValueMember = "CruiseNo"
        CruiseNo.SelectedIndex = -1
    End Sub
    ...
    Private Sub CheckSeatAvailability_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckSeatAvailability.Click
        If Len(Trim(CruiseNo.Text)) = 0 Then
            MessageBox.Show("Please specify the Cruise No.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End If
        ...
        If TravelDate.Value.Date.Subtract(Today.Date).Days > 30 Then
            MessageBox.Show("Reservations for a cruise commence 30 days before the date of the cruise.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        Dim connectionString As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"



        Dim cs As String = "SELECT * FROM ScheduleCruise "
        ...
        myAdapter.Fill(myDataSet, "ScheduleCruise")

        If (myDataSet.Tables("ScheduleCruise").Rows.Count = 0) Then
            MessageBox.Show("Record not found in the ScheduledCrusier table.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Information)

        ElseIf AirwayClass.Text = "First Class" Then
            Dim ca As String = "select FirstClassSeatAvailable from ScheduleCruise where FirstClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "'"
            ...
            Else
                MessageBox.Show("No first class seats available for the specified cruise number, travel date, and class", "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        ElseIf AirwayClass.Text = "Economy Class" Then
            Dim ct As String = "select EconomyClassSeatAvailable from ScheduleCruise where EconomyClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "'"
            ...
            Else
                MessageBox.Show("No economy seats available for the specified cruise number, travel date, and class", "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        ElseIf AirwayClass.Text = "Business Class" Then
            Dim ct As String = "select BusinessClassSeatAvailable from ScheduleCruise where BusinessClassSeatAvailable > 0 and ScheduleCruise.CruiseNo = '" & CruiseNo.Text & "' and TourDate = '" & TravelDate.Text & "'"
            ...
            Else
                MessageBox.Show("No seats available for the specified cruise number, travel date, and class", "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub CruiseNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CruiseNo.KeyPress
        Dim rdr As SqlDataReader = Nothing
        ...
        If e.KeyChar = Microsoft.VisualBasic.ChrW(13) Then
            If (AirwayClass.Text) = "First Class" Then
                ...
                Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.FirstClassFare FROM  Crusier INNER JOIN Sector ON Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
           ...
           New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
            ...
            If (AirwayClass.Text) = "Business Class" Then
                ...
                Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.BusinessClassFare FROM  Crusier INNER JOIN Sector ON Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
           ...
           New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "CruiseNo"))
            ...
            If (AirwayClass.Text) = "Economy Class" Then
                ...
                Dim ct As String = "SELECT  Sector.Source, Sector.Destination, Sector.EconomyClassFare FROM  Crusier INNER JOIN Sector ON Crusier.SectorID = Sector.SectorID and CruiseNo=@FIND"
    ...
    Private Sub CheckSeatAvailability_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckSeatAvailability.MouseHover
        ...
        ToolTip1.UseAnimation = True
        ToolTip1.ToolTipTitle = ""
        ToolTip1.SetToolTip(CheckSeatAvailability, "to check seat availability in different classes of different Crusier")
    End Sub
    ...
    Private Sub PrintTicket_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles PrintTicket.MouseHover
        ...
        ToolTip1.UseAnimation = True
        ToolTip1.ToolTipTitle = ""
        ToolTip1.SetToolTip(PrintTicket, "to print Cruise ship ticket")
    End Sub
    ...
    Private Sub Button4_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button4.MouseHover
        ...
        ToolTip1.UseAnimation = True
        ToolTip1.ToolTipTitle = ""
        ToolTip1.SetToolTip(Button4, "to get source location, destination location and fare related to selected Cruise No.")
    End Sub
    ...
    Private Sub CruiseNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CruiseNo.SelectedIndexChanged
