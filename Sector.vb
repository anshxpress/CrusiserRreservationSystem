...
Public Class Sector
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
        ...
        con.Open()
        Dim cd As String = "select Source from Crusier,Sector where Sector.SectorID=Crusier.SectorID and Source= '" & Source.Text & "'"
        ...
        con.Open()
        Dim ch As String = "select Destination from Crusier,Sector where Sector.SectorID=Crusier.SectorID and Destination= '" & Destination.Text & "'"
        ...
        Try
            ...
            Dim cxd As String = "select weekdays from Crusier,Sector where Sector.SectorID=Crusier.SectorID and weekday1= '" & WeekDays.Text & "'"
        ...
        con.Open()
        Dim cdf As String = "select FirstClassFare from Crusier,Sector where Sector.SectorID=Crusier.SectorID and FirstClassFare= '" & FirstClassFare.Text & "'"
        ...
        con.Open()
        Dim cda As String = "select BusinessClassFare from Crusier,Sector where Sector.SectorID=Crusier.SectorID and BusinessClassFare= '" & BusinessClassFare.Text & "'"
        ...
        con.Open()
        Dim cdw As String = "select EconomyClassFare from Crusier,Sector where Sector.SectorID=Crusier.SectorID and EconomyClassFare= '" & EconomyClassFare.Text & "'"
        ...
        con.Open()
        Dim ct As String = "select SectorID from  Crusier where SectorID=@find"
       ...
       New SqlParameter("@find", System.Data.SqlDbType.NChar, 10, "SectorID"))
        ...
        Else
            ...
            Dim cf As String = "Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=seaways;Integrated Security=True;"
