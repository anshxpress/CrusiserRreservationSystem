...
Public Class Search_Flight
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT cruiseName,CruiseNo,DepartureTime,ArrivalTime,WeekDays FROM Cruisers,Crusier,sector where Cruisers.CruisersTypeId=Crusier.CruisersTypeId and Crusier.sectorid=sector.sectorid and Source = '" & Source.Text & "' and Destination = '" & Destination.Text & "'"
    ...
    Private Sub Button1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.MouseHover
        ...
        ToolTip1.SetToolTip(Button1, "serach Crusier between entered two locations")
    End Sub
